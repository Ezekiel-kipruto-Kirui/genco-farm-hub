...
const LivestockOfftakeAnalytics = () => {
  ...
  const fetchAnalytics = async () => {
    try {
      const querySnapshot = await getDocs(collection(db, "Livestock Offtake Data"));
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold font-display mb-2">Livestock Offtake Analytics</h2>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={monthlyData}>
              ...
              <Tooltip />
              <Legend />
              <Line type="monotone" dataKey="value" stroke="hsl(217 91% 60%)" name="Offtake" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={regionData}>
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="value" fill="hsl(217 91% 60%)" name="Records" />
            </BarChart>
          </ResponsiveContainer>
        </CardContent>
      </Card>
...
export default LivestockOfftakeAnalytics;
